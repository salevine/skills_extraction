...
This project is indexed by GitNexus as **skills_extraction** (656 symbols, 1520 relationships, 54 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/skills_extraction/process/{processName}` — trace the full execution flow step by step
